...
import com.horizonloop.app.R

/**
 * Custom Phosphor-style icons for Horizon Loop
 * These match the SVG icons used in the web version
 */
object AppIcons {
    
    val Filter: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_filter)
    ...
    val Speed: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_speed)
    
    val AudioMode: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_audio_mode)
    
    val Subtitles: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_subtitles)
    
    val Save: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_save)
    
    val Loop: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_loop)
    ...
    val MusicNote: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_music_note)
    
    val Translate: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_translate)
    
    val VolumeUp: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_volume_up)
    
    val List: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_list)
    
    val PlayTriangle: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_play_triangle)
}